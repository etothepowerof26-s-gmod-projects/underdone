...
function GM.PaperDollEditor.OpenPaperDollEditor()
	...
	local cpcCammeraControls = GAMEMODE.PaperDollEditor.AddCammeraControls(pnlControlsList)
...
function GM.PaperDollEditor.AddCammeraControls(pnlAddList)
	local cpcNewCollapseCat = GAMEMODE.PaperDollEditor.CreateGenericCollapse(pnlAddList, "Cammera Controls")
	cpcNewCollapseCat.Paint = function()
		local tblPaintPanel = jdraw.NewPanel()
		tblPaintPanel:SetDimensions(0, 0, cpcNewCollapseCat:GetWide(), cpcNewCollapseCat:GetTall())
		tblPaintPanel:SetStyle(4, clrTan)
