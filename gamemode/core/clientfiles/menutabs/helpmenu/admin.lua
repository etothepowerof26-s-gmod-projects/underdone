local MapList = {}
MapList[1] = "ud_rebellland_beta_02b"
PANEL = {}
...
function PANEL:Init()
	...
	for _, MapName in pairs(MapList) do
		self.Maplist:AddLine(MapName)
	end
	self.Maplist:SelectFirstItem()

	self.MapSwitchButton = CreateGenericButton(self, "Change Map")
	local SwitchButton = self.MapSwitchButton
	SwitchButton.DoClick = function(Self)
