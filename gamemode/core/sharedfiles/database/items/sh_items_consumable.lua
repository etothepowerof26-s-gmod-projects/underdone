local function AddHealth(AddTable, Amount, Time)
	AddTable.AddedHealth = Amount
	AddTable.AddTime = Time
	return AddTable
end
local function AddAmmo(AddTable, Amount, strType)
	AddTable.AmmoAmount = Amount
	AddTable.AmmoType = strType
	return AddTable
end
...
local Item = QuickCreateItemTable(BaseFood, "item_cookednoodles", "Cooked Chinese Noodles", "Restores your health by 30 over 5 Seconds", "icons/junk_metalcan1")
Item = AddHealth(Item, 30, 5)
Item.Model = "models/props_junk/garbage_metalcan001a.mdl"
Item.Message = "You ate some chinese noodles"
Item.UseSound = "vo/SandwichEat09.wav"
Item.SellPrice = 100
Item.Weight = 1
Item.Stackable = true
...
Item.Message = "You ate an orange"
Item.UseSound = "vo/SandwichEat09.wav"
Item.SellPrice = 8
Item.Weight = 1
Item.Stackable = true
