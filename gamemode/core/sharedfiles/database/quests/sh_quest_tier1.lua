...
Quest.StartingItems["book_chinesebox"] = 1
Quest.ObtainItems = {}
Quest.ObtainItems["item_chinese_box"] = 2
Quest.GainedExp = 50
Quest.GainedItems = {}
